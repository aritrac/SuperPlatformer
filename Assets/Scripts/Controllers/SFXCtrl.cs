...
public class SFXCtrl : MonoBehaviour {
    ...
    public static SFXCtrl instance;         //allows other scripts to access public methods in this class without creating an object of this class.
    public SFX sfx;
    ...
    /// <summary>
    /// Shows the splash effect when the player falls in water
    /// </summary>
